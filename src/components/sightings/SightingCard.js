    ...
    <div className="SightingCard card mb-4 card-dull">
      <ul className="list-group list-group-flush">
        <li className="list-group-item">
          <i className="fas fa-fw fa-map-marker-alt" /> <strong>{sighting.geocode}</strong>
        </li>
        <li className="list-group-item">
        ...
        <li className="list-group-item">
          <i className="fas fa-fw fa-feather-alt" /> {sighting.get_sighting_type_display}&nbsp;
          {sighting.number}&nbsp;{sighting.number === 1 ? 'bird' : 'birds'}
        </li>
        <li className="list-group-item">
          <i className="fas fa-fw fa-user" /> {sighting.contributor} (#{sighting.id})
        </li>
