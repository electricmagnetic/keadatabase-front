...
const RASTER_SOURCE_OPTIONS = {
  type: 'raster',
  tiles: [
    `https://tiles-a.data-cdn.linz.govt.nz/services;key=${
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Source id="topo50" tileJsonSource={RASTER_SOURCE_OPTIONS} />
        <Layer id="topo50" type="raster" sourceId="topo50" minZoom={11} />
        {children}
      </MapboxMap>
    );
  }
